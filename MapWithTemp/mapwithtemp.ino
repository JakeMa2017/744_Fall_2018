...
GoogleMapsDeviceLocator locator; // Map constructor
int ledIndicator = D7; // Blink when publishing a new event
// Publish responsed data
void myHandler(const char *event, const char *data)
{
  if (data)
    Particle.publish("location", data, PRIVATE);
  else
    Particle.publish("location", "null", PRIVATE);
}
...
void setup() {
  ...
  pinMode(ledIndicator, OUTPUT);
    ...
    locator.withEventName("whereAmI");
    Particle.subscribe("hook-response/whereAmI", myHandler, MY_DEVICES);
}
